package com.fujitsu.webframework.common.logging;
...
import com.fujitsu.webframework.common.core.imageUtilities.Shooter;
import com.fujitsu.webframework.common.core.elements.JavascriptActions;
import com.fujitsu.webframework.common.core.helper.User;
...
import com.fujitsu.webframework.common.core.annotations.RelatedIssue;

import com.fujitsu.webframework.common.core.AlertHandler;
import com.fujitsu.webframework.common.core.SelectorStack;
import com.fujitsu.webframework.common.core.TestContext;
import com.fujitsu.webframework.common.core.XMLReader;
...
public class PageObjectLogging extends AbstractWebDriverEventListener implements ITestListener {
  ...
  private static String jiraPath = "https://something.atlassian.net/browse/";
  ...
  public void afterNavigateTo(String url, WebDriver driver) {
    ...
    if (driver.getCurrentUrl().contains(Configuration.getWebsiteDomain())) {
...
//  }
  ...
  public void onStart(ITestContext context) {
    ...
    builder.append("<html><style>"
        ...
        + new UrlBuilder().getUrlForWebsite(Configuration.getWebsiteName()) + "</p>"
    ...
    try {
      //FileInputStream input = new FileInputStream("./src/test/resources/script.txt");
        FileInputStream input = new FileInputStream("/Users/xtcmac1/IdeaProjects/webframework/build/resources/test/script.txt");
